...
public final class Class2 { // ApiCommonMeta의 구성 요소(클래스2)이며, 3개의 Map을 가진 불변 스냅샷이다.

    private static final Class2 EMPTY = new Class2( // 빈 클래스2 스냅샷이다.
    ...
    public Class2(Map<String, String> apiCodeByApiCode, Map<String, String> apiUrlByApiCode, Map<String, String> httpMethodByApiCode) { // 3개의 Map으로 클래스2를 만든다.
    ...
    public static Class2 empty() { // 빈 클래스2 스냅샷을 반환한다.
