...
public final class Class1 { // ApiCommonMeta의 구성 요소(클래스1)이며, 3개의 Map + String을 가진 불변 스냅샷이다.

    private static final Class1 EMPTY = new Class1( // 빈 클래스1 스냅샷이다.
    ...
    public Class1(Map<String, String> apiCodeByApiCode, Map<String, String> apiUrlByApiCode, Map<String, String> httpMethodByApiCode) { // 기존 생성자(호환)다.
        this(null, apiCodeByApiCode, apiUrlByApiCode, httpMethodByApiCode, null); // 추가 Map은 null로 두고 위임한다.
    }

    public Class1(String version, Map<String, String> apiCodeByApiCode, Map<String, String> apiUrlByApiCode, Map<String, String> httpMethodByApiCode) { // 문자열 + 3개의 Map으로 클래스1을 만든다.
        this(version, apiCodeByApiCode, apiUrlByApiCode, httpMethodByApiCode, null); // 추가 Map은 null로 두고 위임한다.
    }

    public Class1(String version, Map<String, String> apiCodeByApiCode, Map<String, String> apiUrlByApiCode, Map<String, String> httpMethodByApiCode, Map<String, Set<String>> stringSetByApiCode) { // 문자열 + 3개의 Map + (Map<String,Set<String>>)으로 클래스1을 만든다.
    ...
    public static Class1 empty() { // 빈 클래스1 스냅샷을 반환한다.
